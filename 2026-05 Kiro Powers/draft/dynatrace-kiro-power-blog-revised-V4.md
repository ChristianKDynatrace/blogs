...
## (2) What is the Dynatrace power for Kiro?

The Dynatrace power for Kiro is a one-click bundle that brings live observability data, root-cause analysis, and remediation suggestions into the Kiro IDE, with no JSON editing or manual MCP setup.
...
### (1) Configure your tenant and token
...
### (2) Configure your tenant and token
...
The short demo below walks through installing the Dynatrace power, verifying the connection, and running a first query against your environment: listing the top 10 vulnerabilities Dynatrace has detected.
